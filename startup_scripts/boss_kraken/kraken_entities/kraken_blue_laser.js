const BLUE_LASER_DIRECT_HIT_DAMAGE = 15
...
StartupEvents.registry('entity_type', event => {
    ...
    event.create("frontiers:kraken_blue_laser", "entityjs:geckolib_projectile")
        ...
        .onHitEntity(context => {
            ...
            hitEntity.attack(damageSource, BLUE_LASER_DIRECT_HIT_DAMAGE)
            ...
            world.spawnParticles("galosphere:allurite_rain", false, collisionX, collisionY, collisionZ, 0.5, 0.5, 0.5, particleCountPerTick, particleSpeedPerTick)
