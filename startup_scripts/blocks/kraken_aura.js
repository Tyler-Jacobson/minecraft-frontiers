const KRAKEN_AURA_DISPLAY_RADIUS = 2
      ...
      entityInfo.tick(1, 0, entity => {
        ...
        if (level.time % 10 === 0) {
          for (let step = 0; step < 12; step++) {
            ...
            let particleX = posX + 0.5 + Math.cos(angle) * KRAKEN_AURA_DISPLAY_RADIUS
            let particleZ = posZ + 0.5 + Math.sin(angle) * KRAKEN_AURA_DISPLAY_RADIUS
